...
const coordinators = [
  { id: "coord-1", name: "João Silva" },
  { id: "coord-2", name: "Maria Oliveira" },
  { id: "coord-3", name: "Pedro Santos" },
];
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Crie um novo programa estratégico com cronograma, metas e marcos.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 py-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      ...
                      <FormMessage />
                      <FormDescription>
                        Defina quando o programa deve terminar (opcional)
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Orçamento total previsto para o programa
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium">Marcos do Programa</h3>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
