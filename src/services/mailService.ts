...
export async function createDocument(document: Partial<Document>) {
  // We need to cast the document data to include a temporary protocol_number
  // The actual protocol_number will be generated by the database trigger
  const documentWithProtocol = {
