...
export async function createDirectRequest(request: CreateDirectRequestDTO): Promise<DirectRequest | null> {
  try {
    // The protocol_number is auto-generated by the database trigger, we don't need to include it
    // But the field is required in the schema, so we pass an empty string which will be overridden
