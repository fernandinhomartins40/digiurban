 ...
 * 
 * Note: Protocol number will be set by database trigger
 */
export const createRequest = async (
  ...
  try {
    // Use null for protocol_number to let the database trigger handle it
    const { data: requestData, error } = await supabase
      ...
      .insert({
        ...
        protocol_number: null // This will be overwritten by the database trigger
      })
      .select(`
        *,
        request_type:request_type_id(name, description)
